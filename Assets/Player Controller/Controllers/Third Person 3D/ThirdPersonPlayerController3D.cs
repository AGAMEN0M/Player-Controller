...
namespace PlayerController
{
    ...
    /// </summary>
    [AddComponentMenu("Tools/Player Controller/3D/Player Controller (Third Person)")]
    public partial class ThirdPersonPlayerController3D : MonoBehaviour
    {
        #region === Enums ===
        ...
        private Transform worldCameraPivot;
        ...
        private void ValidateSerializedReferences()
        {
            ...
            if (!worldCameraPivot) Debug.LogWarning("World Camera Pivot not assigned.", this);
    ...
    public partial class ThirdPersonPlayerController3D
    {
        [CanEditMultipleObjects]
        [CustomEditor(typeof(ThirdPersonPlayerController3D))]
        public class ThirdPersonPlayerController3DEditor : CustomInspectorBase<ThirdPersonPlayerController3D>
        {
            /// <summary>
            /// Renders the custom inspector layout for the ThirdPersonPlayerController3D component.
            ...
            protected override void DrawInspector()
            {
                ...
                DrawGroup(new GUIContent("Camera Settings", "Controls camera pivot positioning and smoothing between standing and crouching states."), () =>
                {
                    ...
                    GUIProperty(nameof(script.worldCameraPivot));
