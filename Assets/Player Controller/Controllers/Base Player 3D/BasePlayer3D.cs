...
namespace PlayerController
{
    ...
    /// </summary>
    [AddComponentMenu("Tools/Player Controller/3D/Player Controller (Base)")]
    public partial class BasePlayer3D : MonoBehaviour
    {
        #region === Enums ===
    ...
    public partial class BasePlayer3D
    {
        [CanEditMultipleObjects]
        [CustomEditor(typeof(BasePlayer3D))]
        public class BasePlayer3DEditor : CustomInspectorBase<BasePlayer3D>
        {
            /// <summary>
            /// Renders the custom inspector layout for the BasePlayer3D component.
