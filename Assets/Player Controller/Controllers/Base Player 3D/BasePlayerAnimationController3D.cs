...
{
    [Header("References")]
    [SerializeField, HighlightEmptyReference] private BasePlayer3D playerController; // Reference to the player controller.
    ...
    [SerializeField] private string running = "Running"; // Animator bool for running.
    ...
    [SerializeField] private string crawlingRunning = "Crouch Running"; // Animator bool for crouch running.
