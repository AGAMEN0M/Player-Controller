/*
 * ---------------------------------------------------------------------------
 * Description: Controls the 3D side-view player animation states using boolean 
 *              Animator parameters. Dynamically evaluates player state and ensures that only 
 *              one animation is active at a time based on grounded, movement, crouching, 
...
{
    [Header("References")]
    [SerializeField, ValidateReference] private SideViewPlayerController3D playerController; // Reference to the player controller.
