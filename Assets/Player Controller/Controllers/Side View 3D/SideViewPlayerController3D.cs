 ...
 *              Manages input, movement, jumping, crouching, running, rotation, stamina, 
 *              and collision detection using modular systems and sensor logic. 
...
namespace PlayerController
{
    ...
    /// </summary>
    [AddComponentMenu("Tools/Player Controller/3D/Player Controller (Side View)")]
    public partial class SideViewPlayerController3D : MonoBehaviour
    {
        #region === Enums ===
        ...
        private float globalInputRotationOffset = 0f;
    ...
    public partial class SideViewPlayerController3D
    {
        [CanEditMultipleObjects]
        [CustomEditor(typeof(SideViewPlayerController3D))]
        public class SideViewPlayerController3DEditor : CustomInspectorBase<SideViewPlayerController3D>
        {
            /// <summary>
            /// Renders the custom inspector layout for the SideViewPlayerController3D component.
