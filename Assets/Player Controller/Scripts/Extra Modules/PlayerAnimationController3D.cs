...
namespace PlayerController
{
    ...
    /// </summary>
    [AddComponentMenu("Tools/Player Controller/Extra Modules/Player Animation Controller [3D]")]
    public class PlayerAnimationController3D : MonoBehaviour
    {
        ...
        private string crawling = "Crouch Walking";

        [SerializeField, Tooltip("Animator parameter name for the crouch running state.")]
        private string crawlingRunning = "Crouch Running";

        [Header("Debug (Read Only)")]
        [SerializeField, ReadOnly, Tooltip("Currently active animation state, updated at runtime.")]
