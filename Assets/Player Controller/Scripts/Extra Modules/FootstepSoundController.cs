...
namespace PlayerController
{
    ...
    /// </summary>
    [AddComponentMenu("Tools/Player Controller/Extra Modules/Footstep Sound Controller")]
    public class FootstepSoundController : MonoBehaviour
    {
        ...
        private float minimumPitch = 0.8f;
        ...
        private List<AudioClip> crouchClips;
        ...
        private List<AudioClip> landingClips;
