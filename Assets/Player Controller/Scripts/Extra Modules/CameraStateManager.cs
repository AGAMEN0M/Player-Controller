...
namespace PlayerController
{
    ...
    /// </summary>
    [AddComponentMenu("Tools/Player Controller/Extra Modules/Camera State Manager")]
    public class CameraStateManager : MonoBehaviour
    {
        ...
        private UpdateType updateType = UpdateType.InputEvent;
        ...
        private List<GameObject> activationObjects = new();
